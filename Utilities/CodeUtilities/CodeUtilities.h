...
* - That means that all non-template methods and functions
*   must be declared inline.  Link errors may result if you
*   don't do that.
*
...
namespace Utilities
{
  ...
  public:
    ...
    // copy construction and assignment are deleted because the class
    // holds a reference to an iostream, and C++ reference types can not
    // be copied or assigned to.
